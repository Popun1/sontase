...
public class LoginControl extends HttpServlet {
     ...
     */
        ...
        if (action.equals("checkLogin")) {
            ...
            UserDTO user = dao.checkUser(user_email, user_pass);
            if (user == null) {
        ...
        if (action.equals("updateinfo")) {
            try {
                ...
                if (user != null) {
                    ...
                    UserDTO user1 = new UserDTO(user.getUser_id(), user_name, user.getUser_email(), user_pass, user.getIsAdmin());
        ...
        if (action.equals("signup")) {
            ...
            if (!user_pass.equals(re_pass)) {
                ...
                UserDAO dao = new UserDAO();
                UserDTO user = dao.checkAcc(user_email);
                if (user == null) {
